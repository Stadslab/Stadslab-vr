...
public class LaserSnijders_pm25 : MonoBehaviour
{
    ...
    private static double sensorValuepm2_5;
    ...
    void Update()
    {
        ...
        sensorValuepm2_5 = pm2_5Device1;

        Debug.Log("lasersnijders_pm25 " + sensorValuepm2_5);

        if(sensorValuepm2_5 <= 4) {     //verander deze waarde als je de grenzen voor de kleurveranderingen wilt aanpassen
        ...
        } else if(sensorValuepm2_5 > 4 && sensorValuepm2_5 < 6) {      //verander deze waarde als je de grenzen voor de kleurveranderingen wilt aanpassen
            grad.SetKeys(new GradientColorKey[] {new GradientColorKey(Color.green, 0.0f), new GradientColorKey(Color.yellow, 1.0f)}, 
                new GradientAlphaKey[] {new GradientAlphaKey(1.0f, 0.0f), new GradientAlphaKey(1.0f, 0.0f)});

        } else if(sensorValuepm2_5 > 6) {  //verander deze waarde als je de grenzen voor de kleurveranderingen wilt aanpassen
